...
tmp_dir="/home/gma/tmp/minigo_tf1.13"
#tmp_dir="/home/gma/minigo_tf_intel"
#tmp_dir="/home/gma/tensorflow"
tmp_pkg_dir="/home/gma/tmp/tensorflow_pkg"
...
#export CC=/home/gma/anaconda3/envs/tf-dev36/bin/gcc
#export CXX=/home/gma/anaconda3/envs/tf-dev36/bin/g++
#cc_opt_flags= "-mavx -mavx2 -mfma -mavx512f -mavx512pf -mavx512cd -mavx512er"
...
. ~/delock-minigo/set_avx2_build
BAZEL_OPTS="-c opt --config=mkl --action_env=PATH --action_env=LD_LIBRARY_PATH --copt=-L/home/gma/bin/gcc6.3/lib64 $BAZEL_BUILD_OPTS --copt=-DINTEL_MKLDNN"
...
#echo "Building toco"
#bazel build -s $BAZEL_OPTS //tensorflow/contrib/lite/toco:toco
